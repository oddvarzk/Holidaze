  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between justify-center">
      ...
      <div className="px-5 py-5 md:w-1/2">
        ...
        <p className="font-Montserrat ml-4 text-gray-500 font-normal text-md mt-2 max-w-4xl">
        ...
        <ul className="font-Montserrat ml-8 text-gray-500 font-normal text-md mt-2 max-w-4xl list-disc">
          <li>
